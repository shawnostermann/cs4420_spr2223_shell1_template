...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_oneline = 14,                   /* oneline  */
  YYSYMBOL_term = 15,                      /* term  */
  YYSYMBOL_expr = 16,                      /* expr  */
  YYSYMBOL_oper = 17                       /* oper  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EOLN", "PLUS",
  "MINUS", "TIMES", "DIVIDE", "LPAREN", "RPAREN", "NUMBER", "$accept",
  "input", "lines", "oneline", "term", "expr", "oper", YY_NULLPTR
};
...
{
       8,    -3,     1,    10,    17,    -4,     1,    11,     2,     2,
       3,     3,     0,     2,    19,     3,    12,    13,    14,    15,
      18
};
...
{
       0,     1,     8,    10,    12,    13,    14,    15,    15,    16,
       0,     3,     4,     5,     6,     7,    17,     9,    13,    15
};
...
#line 1106 "parser.tab.c"
  ...
  case 10: /* expr: term oper term  */
#line 60 "parser.y"
          {
	      struct exprtree *pexpr;

	      pexpr = (struct exprtree *) MallocZ(sizeof(struct exprtree));
	      pexpr->left = (yyvsp[-2].pexpr);
	      pexpr->right = (yyvsp[0].pexpr);
	      pexpr->operator = (yyvsp[-1].op);
	      (yyval.pexpr) = pexpr;
	  }
