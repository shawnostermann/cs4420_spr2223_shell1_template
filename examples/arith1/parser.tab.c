...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_oneline = 12,                   /* oneline  */
  YYSYMBOL_expr = 13,                      /* expr  */
  YYSYMBOL_rhs = 14,                       /* rhs  */
  YYSYMBOL_oper = 15                       /* oper  */
};
...
static const char *const yytname[] =
{
  ...
  "MINUS", "TIMES", "DIVIDE", "NUMBER", "$accept", "input", "lines",
  "oneline", "expr", "rhs", "oper", YY_NULLPTR
};
...
{
      -3,     1,    -4,     1,    13,     2,    14,    16,     2,     0,
       2,     8,     9,    10,    11,     0,     0,    15
};

static const yytype_int8 yycheck[] =
{
       0,     1,     0,     1,     0,     8,     3,    14,     8,    -1,
       8,     4,     5,     6,     7,    -1,    -1,    12
};
...
#line 81 "parser.y"
        {
	      (yyval.pop) = (struct opchain *) MallocZ(sizeof(struct opchain));
